...
export class WalletLedgerEntry {
  ...
  static create(props: CreateLedgerEntryProps): WalletLedgerEntry {
    ...
    if (!entry.isBalanced()) {
      throw new Error(`Ledger entry is not balanced. Before: ${props.balanceBefore.toString()}, After: ${props.balanceAfter.toString()}, Diff: ${props.money.toString()}, Direction: ${props.direction}`);
    }
